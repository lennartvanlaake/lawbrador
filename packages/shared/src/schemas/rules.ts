...
import { ALL_SELECTION_LOCATIONS, ALL_SELECTION_OPERATORS } from './ruleConstants';
import { keyValue } from './generic';

export const selectionOperator = Type.Union(ALL_SELECTION_OPERATORS.map((op) => Type.Literal(op)));
...
export const urlComponent = Type.Union([staticUrlComponent, variableUrlComponent]);
