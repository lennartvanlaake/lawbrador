import { az as e, ac as i, aA as s } from './vendor.499b2e68.js';
var t;
function l(r, o) {
	return (
		o || (o = r.slice(0)),
...
var a = e(t || (t = l(['0%{z-index:0}to{z-index:-1}']))),
	n = function (o) {
		return {
			...
			'.os-resize-observer': { animationDuration: '.001s', animationName: ''.concat(a) },
	...
	b = function () {
		return i.createElement(s, { styles: n });
	};
b.displayName = 'GlobalScrollAreaStyles';
export { b as default, n as getScrollAreaStyles };
//# sourceMappingURL=GlobalScrollAreaStyles.4114620f.js.map
